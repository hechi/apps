    ...
    <table border="0">
        ...
        <tr>
            ...
            <td>
                ...
                <input id="searchMember" class="ui-autocomplete-input" type="text" placeholder="Share with" autocomplete="on">
                <ul id="memberList"></ul>                   
            </td>
            <!--<td>
        ...
        <tr>
            ...
            <td>
                ...
                <input id="searchAdmin" class="ui-autocomplete-input" type="text" placeholder="Share with" autocomplete="on">
                <ul id="adminList"></ul>     
            </td>
        </tr>
    </table>
